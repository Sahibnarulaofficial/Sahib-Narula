          ...
          <div className="w-full">
            <form ref={formElRef} onSubmit={handleSubmit} className="flex flex-col gap-4 sm:gap-5" noValidate>
              ...
              <p className="font-mono text-[9px] text-content-secondary/30 tracking-wider">
                Or email directly: hello@sahibnarula.com
              </p>
            </form>
          </div>
          ...
          <div className="flex flex-col gap-10 lg:pl-10 lg:border-l border-brand-detail">
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="flex flex-col gap-4">
                {/* Email */}
                <a href="mailto:hello@sahibnarula.com" className="group flex items-center gap-4 text-content-secondary hover:text-content-primary transition-colors duration-200">
                ...
                {/* LinkedIn */}
                <a href="#" target="_blank" rel="noopener noreferrer" className="group flex items-center gap-4 text-content-secondary hover:text-content-primary transition-colors duration-200">
                  <div className="w-12 h-12 border border-brand-detail rounded-full flex items-center justify-center flex-shrink-0 group-hover:border-accent group-hover:bg-accent/10 group-hover:text-accent transition-all duration-300">
            ...
            <div className="flex flex-col gap-6 pt-4 border-t border-brand-detail/50 lg:border-none lg:pt-0">
              ...
              <div className="flex flex-col gap-4">
                {/* Resume */}
                <a href="/resume.pdf" target="_blank" rel="noopener noreferrer" className="group flex items-center gap-4 text-content-secondary hover:text-content-primary transition-colors duration-200">
                  <div className="w-12 h-12 border border-brand-detail rounded-full flex items-center justify-center flex-shrink-0 group-hover:border-accent group-hover:bg-accent/10 group-hover:text-accent transition-all duration-300">
